...
ace.define("ace/mode/markdown",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/markdown_highlight_rules","ace/mode/folding/markdown","ace/mode/javascript","ace/mode/php","ace/mode/php_laravel_blade","ace/mode/html","ace/mode/sh","ace/mode/sh","ace/mode/xml","ace/mode/css"], function(acequire, exports, module) {
  'use strict';

  var oop = acequire('../lib/oop');
  var TextMode = acequire('./text').Mode;
  var MarkdownHighlightRules = acequire('./markdown_highlight_rules')
  ...
  var Mode = function() {
    ...
    this.createModeDelegates({
      ...
      php: acequire('./php').Mode,
      blade: acequire('./php_laravel_blade').Mode,
